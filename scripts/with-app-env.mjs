...
/**
 * Resolve a local bin (e.g. vite) under node_modules/.bin so Windows finds
 * vite.cmd without relying on shell PATH quirks.
 */
...
function main(argv) {
  ...
  // shell: true is required on Windows so .cmd shims in node_modules/.bin run.
